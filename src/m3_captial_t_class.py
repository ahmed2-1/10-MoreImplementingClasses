...
class CapitalT(object):
    ...
    def clone(self):
        ...
        height = (self.v_rect.get_lower_right_corner().y-self.v_rect.get_upper_right_corner().y)
        letter_thickness = (self.v_rect.get_upper_right_corner().x-self.v_rect.get_upper_left_corner().x)
